...
class PwTorrentPeerDao extends PwBaseDao
{
    ...
    protected $_pk         = 'id';
    protected $_dataStruct = array('id', 'torrent', 'peer_id', 'uid', 'ip', 'port', 'uploaded', 'downloaded', 'left', 'seeder', 'started_at', 'last_action', 'connectable', 'agent', 'finished_at', 'passkey');
