    ...
    public function run($cronId) {
        ...
        foreach ($fids as $fid) {
            ...
            foreach ($topics as $topic) {
                ...
                foreach ($peers as $peer) if (strtotime($peer['last_action']) < strtotime('-' . Wekit::C('site', 'app.torrent.cron.peertimeout') . ' minute')) Wekit::load('EXT:torrent.service.PwTorrentPeer')->deleteTorrentPeer($peer['id']);
            }
        }
    }
}
